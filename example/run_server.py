from pymcp.registry import tool_registry, resource_registry
from pymcp.server import app


@resource_registry.resource(
    uri="resource://dynamic/hello",
    name="Hello Resource",
    description="A dynamic resource that returns a greeting.",
    mimeType="text/plain"
)
def hello_resource():
    return "Hello from a dynamic resource!"
...
if __name__ == "__main__":
    # Test the resource registry directly
    import uvicorn
